                                ...
                                <tr class="hover:bg-gray-700/30 transition duration-150 group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            @if($project->hasImage())
                                                <div class="h-9 w-9 rounded overflow-hidden mr-3 border border-white/10 shrink-0">
                                                    <img src="{{ $project->image_url }}" alt="Logo" class="w-full h-full object-cover">
                                                </div>
                                            @else
                                                <div class="h-9 w-9 rounded bg-gradient-to-br from-ito-orange to-amber-600 flex items-center justify-center text-white font-bold text-xs mr-3 shrink-0">
                                                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
