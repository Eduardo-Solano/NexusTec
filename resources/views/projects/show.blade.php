                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                @if($project->hasImage())
                                    <a href="{{ $project->image_url }}" target="_blank" 
                                       class="group flex items-center gap-4 p-4 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/50 hover:bg-purple-500/10 transition-all duration-300">
                                        <div class="w-14 h-14 rounded-xl overflow-hidden border border-white/10 group-hover:border-purple-500/30 transition-colors shadow-lg relative">
                                            <img src="{{ $project->image_url }}" alt="Imagen del proyecto" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                        </div>
                                        <div class="flex-1">
                                            <p class="text-white font-bold group-hover:text-purple-400 transition-colors">Imagen/Logo</p>
                                            <p class="text-gray-500 text-xs text-shadow-sm">Ver imagen completa</p>
                                        </div>
