                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="employee_number"
                                class="block mt-1 w-full bg-gray-900 border-gray-600 text-white @error('employee_number') border-red-500 @enderror"
                                type="text" name="employee_number" :value="old('employee_number')" required
                        ...
                        <div>
                            ...
                            <select name="department"
                                class="block mt-1 w-full bg-gray-900 border-gray-600 text-white rounded-md shadow-sm focus:border-ito-orange focus:ring-ito-orange @error('department') border-red-500 @enderror">
                                <option value="">Seleccionar departamento</option>
                                <option value="Sistemas y Computación"
                                    @if (old('department') == 'Sistemas y Computación') selected @endif>Sistemas y Computación</option>
                                <option value="Ciencias Básicas" @if (old('department') == 'Ciencias Básicas') selected @endif>
                                    Ciencias Básicas</option>
                                <option value="Industrial" @if (old('department') == 'Industrial') selected @endif>Industrial
                                </option>
                                <option value="Económico-Administrativo"
                                    @if (old('department') == 'Económico-Administrativo') selected @endif>Económico-Administrativo</option>
                            </select>
                            @error('department')
                                <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                            @enderror
