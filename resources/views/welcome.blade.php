...
<body class="antialiased bg-gray-50 text-gray-800" x-data="{ showDevelopers: false }">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center p-6 rounded-2xl bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <p class="text-gray-600 text-sm">Forma equipos, invita compañeros y colabora en proyectos
                        innovadores.</p>
                </div>
                ...
                <div class="text-center p-6 rounded-2xl bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <p class="text-gray-600 text-sm">Sistema de rúbricas y jueces para evaluaciones justas y
                        transparentes.</p>
                </div>
    ...
    <div x-show="showDevelopers" x-transition:enter="transition ease-out duration-300"
        ...
        x-transition:leave-end="opacity-0" @click.self="showDevelopers = false"
        class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm"
        style="display: none;">

        <div x-show="showDevelopers" x-transition:enter="transition ease-out duration-300 transform"
            ...
            <div class="flex justify-center mb-6">
                <svg class="w-24 h-24 text-ito-orange animate-spin-slow" fill="currentColor" viewBox="0 0 24 24">
                    <path
                        d="M12 2l2.5 2.5L17 2v5l2.5-2.5L22 7l-5 2.5L22 12l-2.5 2.5L22 17l-2.5 2.5L17 22v-5l-2.5 2.5L12 22l-2.5-2.5L7 22v-5l-2.5 2.5L2 17l5-2.5L2 12l2.5-2.5L2 7l2.5-2.5L7 2v5l2.5-2.5L12 2z" />
                </svg>
            </div>
            ...
            <div class="space-y-3">
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-ito-orange rounded-full flex items-center justify-center text-white font-bold text-lg">
                            JF
                        </div>
                        <div>
