    ...
    <div class="min-h-screen py-12 relative z-10">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center text-sm font-medium text-gray-400 mb-6">
                <a href="{{ route('students.index') }}" class="group flex items-center hover:text-white transition-colors duration-300">
                    ...
                    <span>Volver a Lista de Alumnos</span>
                </a>
            </nav>
                    ...
                    <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input id="name" class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 rounded-xl shadow-inner transition-all duration-300 hover:bg-black/30 backdrop-blur-sm" 
                                    type="text" name="name" :value="old('name')" required maxlength="255" placeholder="Ej: Juan Pérez" autofocus />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input id="email" class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 rounded-xl shadow-inner transition-all duration-300 hover:bg-black/30 backdrop-blur-sm" 
                                    type="email" name="email" :value="old('email')" required maxlength="255" autocomplete="email" placeholder="l21212121@tecnm.mx" />
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-input-label for="control_number" :value="__('No. Control')" class="text-white font-bold mb-2 text-sm uppercase tracking-wider" />
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-500 group-focus-within:text-blue-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <input id="control_number" class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 rounded-xl shadow-inner transition-all duration-300 hover:bg-black/30 backdrop-blur-sm" 
                                        type="text" name="control_number" :value="old('control_number')" required maxlength="255" placeholder="Ej: 21212121"/>
                                </div>
                            </div>
                            <div>
                                <x-input-label for="major" :value="__('Carrera')" class="text-white font-bold mb-2 text-sm uppercase tracking-wider" />
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-500 group-focus-within:text-blue-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <select name="career_id" required class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white rounded-xl shadow-inner focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all duration-300 hover:bg-black/30 backdrop-blur-sm appearance-none cursor-pointer">
                                        <option value="" class="bg-gray-900 text-gray-400">Seleccionar carrera</option>
                                        @foreach ($careers as $career)
                                            <option value="{{ $career->id }}" @if(old('career_id') == $career->id) selected @endif class="bg-gray-900 text-white">{{ $career->name }}</option>                                  
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input id="password" class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 rounded-xl shadow-inner transition-all duration-300 hover:bg-black/30 backdrop-blur-sm" 
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input id="password_confirmation" class="block w-full pl-10 py-3 bg-black/20 border border-white/10 text-white placeholder-gray-500 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 rounded-xl shadow-inner transition-all duration-300 hover:bg-black/30 backdrop-blur-sm" 
                        ...
                        <div class="flex items-center justify-between mt-8 pt-6 border-t border-white/10">
                            <a href="{{ route('students.index') }}" class="text-sm font-bold text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
