        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <label class="cursor-pointer">
                    ...
                    <div
                        class="rounded-lg border border-gray-600 bg-gray-800 p-4 text-center text-gray-400 hover:bg-gray-700 peer-checked:border-orange-500 peer-checked:bg-orange-900 peer-checked:text-white transition">
                        🎓 Estudiante
                    </div>
                </label>
                <label class="cursor-pointer">
        ...
        <div x-show="role === 'student'" class="mt-4 space-y-4 border-t border-gray-700 pt-4" x-transition>
            ...
            <div>
                ...
                <x-text-input id="control_number"
                    class="block mt-1 w-full bg-gray-900 border-gray-600 text-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-lg"
                    type="text" name="control_number" :value="old('control_number')" />
            </div>
            ...
            <div>
                ...
                <x-text-input id="semester"
                    class="block mt-1 w-full bg-gray-900 border-gray-600 text-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-lg"
                    type="number" min="1" max="14" name="semester" />
            </div>
        </div>

        <div x-show="role === 'judge'" class="mt-4 space-y-4 border-t border-gray-700 pt-4" x-transition
            style="display: none;">
        ...
        <div class="mt-6 space-y-4 border-t border-gray-700 pt-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePasswordRegister('password', 'password')"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button"
                        onclick="togglePasswordRegister('password_confirmation', 'password_confirmation')"
                        class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-orange-500">
                        <svg id="eye-icon-password_confirmation" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <svg id="eye-slash-icon-password_confirmation" xmlns="http://www.w3.org/2000/svg"
