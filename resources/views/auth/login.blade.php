<x-guest-layout :hideLogo="true">
    <div class="flex justify-center items-center gap-8 mb-10">
        <img src="{{ asset('img/logo-tecnm.png') }}" class="h-14 w-auto filter brightness-0 invert opacity-90"
            alt="TecNM">

        <div class="h-12 w-px bg-gray-600"></div>

        <img src="{{ asset('img/logo-ito.png') }}" class="h-16 w-auto" alt="ITO">
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email"
                class="block mt-1 w-full bg-gray-900 border-gray-700 text-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-lg"
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                <x-text-input id="password"
                    class="block mt-1 w-full bg-gray-900 border-gray-700 text-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-lg pr-10"
                ...
                <button type="button" onclick="togglePassword('password')"
                    ...
                    <svg id="eye-slash-icon-password" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <div class="flex items-center justify-between mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    class="rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-ito-orange shadow-sm focus:ring-ito-orange"
                    name="remember">
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Recordarme') }}</span>
            </label>

            @if (Route::has('password.request'))
                <a class="text-sm text-gray-600 dark:text-gray-400 hover:text-ito-orange rounded-md focus:outline-none"
        ...
        <div class="flex items-center justify-center mt-6">
            <button
                class="w-full justify-center bg-ito-orange hover:bg-orange-600 text-white font-bold py-3 px-4 rounded">
                {{ __('Iniciar Sesión') }}
            </button>
        </div>
