...
Route::post('/teams/{team}/invitations/accept', [TeamController::class, 'acceptInvitation'])
    ->middleware(['auth'])
    ->name('teams.invitations.accept');

// Rechazar invitación a equipo
Route::post('/teams/{team}/invitations/reject', [TeamController::class, 'rejectInvitation'])
    ->middleware(['auth'])
    ->name('teams.invitations.reject');
Route::post(
    '/teams/{team}/invitations/{notification?}/accept',
    [TeamController::class, 'acceptInvitation']
)
    ->middleware(['auth'])
    ->name('teams.invitations.accept');

Route::post(
    '/teams/{team}/invitations/{notification?}/reject',
    [TeamController::class, 'rejectInvitation']
)
    ->middleware(['auth'])
    ->name('teams.invitations.reject');
